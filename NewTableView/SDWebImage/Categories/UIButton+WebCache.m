...
- (void)webImageManager:(SDWebImageManager *)imageManager didFinishWithImage:(UIImage *)image forURL:(NSURL *)url userInfo:(NSDictionary *)info
{
    ...
    else
    {
        ...
        [self setImage:resizeImage forState:UIControlStateNormal];
        [self setImage:resizeImage forState:UIControlStateSelected];
        [self setImage:resizeImage forState:UIControlStateHighlighted];
    }
}
